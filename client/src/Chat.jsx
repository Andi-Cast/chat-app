            ...
            <div className="bg-blue-50 flex flex-col w-2/3 p-2">
                            ...
                            <div className="overflow-y-scroll absolute inset-0">
                                {messagesWithoutDupes.map(message => (
                                    <div key={message._id}className={(message.sender === id ? 'text-right' : 'text-left')}>
                                        <div className={"inline-block p-2 my-2 rounded-md text-sm " + (message.sender === id ? 'bg-blue-500 text-white' : 'bg-gray-500 text-white')}>
                                            {message.text}
                                            {message.file && (
                                                <div>
                ...
                {!!selectedUserId && (
                    <form className="flex gap-2" onSubmit={sendMessage}>
                        ...
                        />
                        <label className="bg-gray-400 p-2 text-white rounded-lg cursor-pointer flex items-center">
